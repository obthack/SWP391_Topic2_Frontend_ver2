...
export const Dashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const views = listings?.reduce((sum, l) => sum + (l.views_count || 0), 0) || 0;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Chào mừng, {profile?.full_name}!</h1>
          <p className="text-gray-600 mt-2">Quản lý tin đăng và theo dõi hoạt động của bạn</p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-orange-600 mt-2">{stats.soldListings}</p>
              </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Tin đăng của bạn</h2>
                <Link
                  to="/create-listing"

...
import { Users, Package, DollarSign, TrendingUp, CheckCircle, XCircle, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Tin đăng chờ duyệt</h2>
                ...
                {recentTransactions.map((transaction) => (
                  <div key={transaction.id} className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="text-sm text-gray-600">
                      <p>Số tiền: {formatPrice(transaction.amount)}</p>
                      <p>Hoa hồng: {formatPrice(transaction.commission || 0)}</p>
                      <p className="text-xs text-gray-500 mt-1">
